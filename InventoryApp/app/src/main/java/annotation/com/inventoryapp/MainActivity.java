...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent intent = new Intent(MainActivity.this, DaitalsActivity.class);
    ...
    private void insertPet() {
        ...
        Uri path = Uri.parse("android.resource://annotation.com.inventoryapp/" + R.drawable.android);

        ContentValues values = new ContentValues();
        values.put(ProductsContract.ProductEntry.COLUMN_PRODUCT_NAME, "Toto");
        values.put(ProductsContract.ProductEntry.COLUMN_PRICE, "27");
        values.put(ProductsContract.ProductEntry.COLUMN_QUANTITY, 17);
        values.put(ProductsContract.ProductEntry.COLUMN_IMAGE, String.valueOf(path));
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        return new CursorLoader(this,   // Parent activity context
                ProductsContract.ProductEntry.CONTENT_URI,   // Provider content URI to query
